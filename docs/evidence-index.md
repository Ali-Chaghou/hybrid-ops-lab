...
| Publisher-Aktivierung, E2E, Disable/Re-enable, Failure Injection und Redelivery / D3B2.3 | Live verifiziert, Gesamtnachweis noch offen | [D3B2.3-Runtime-Nachweis](evidence-d3b2.3.md); [Roadmap](roadmap.md) | 02.07.2026 | Validation/Poison, vollständiger DLQ-Weg, Redrive oder dokumentierte ElasticMQ-Grenze offen |
| Phase 3 gesamt | In progress; noch nicht formal abgeschlossen | [README, Phase 3](../README.md); [Roadmap](roadmap.md) | — | Poison-/DLQ-/Redrive-Nachweise und Gesamtcheck offen |
